...
recipes.remove(<mujmajnkraftsbettersurvival:itemdesertchitinhammer>);
recipes.remove(<mujmajnkraftsbettersurvival:itemjunglechitinhammer>);
recipes.remove(<mujmajnkraftsbettersurvival:itemdesertchitinspear>);
recipes.remove(<mujmajnkraftsbettersurvival:itemjunglechitinspear>);
recipes.remove(<mujmajnkraftsbettersurvival:itemdesertchitinbattleaxe>);
recipes.remove(<mujmajnkraftsbettersurvival:itemjunglechitinbattleaxe>);
